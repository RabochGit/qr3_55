...
bot = telebot.TeleBot("6545363255:AAHe0G0KnJkUkziSG98Z1ShcuMwjumXGAMI",
...
text_poll = "Расписание"  # Можно менять текст
text_button_1 = "Группа"  # Можно менять текст
text_button_2 = "Дата"  # Можно менять текст
text_button_3 = "Кабинет"  # Можно менять текст
...
def start_ex(message):
    bot.send_message(
        message.chat.id,
        'Привет! Хочешь узнать расписание?',  # Можно менять текст
